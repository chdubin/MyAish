...
namespace MainBL
{
 ...
 // this was added on feb 2 from version i had download from github
 public FileRoyaltiesEntity[] SelectFilesByRoyalties(MainEntity.Models.Activity.RoyaltyLog[] files, List<MainEntity.Models.File.FileRoyaltiesEntity> fileList)
        {
            return this.Exec(System.Data.IsolationLevel.Snapshot,
            (FileDbManager context) =>
            {
                return context.SelectFilesByRoyalties(files, fileList).ToArray();
            });
        }
