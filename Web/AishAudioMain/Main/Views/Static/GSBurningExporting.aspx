	...
	<div id="content_thin2">
		...
		<div style="float: left; margin-top: 15px; width: 549px;">
			...
			<div id="Get_start_right1">
				<img src="<%= Url.Image("burningexporting_top.jpg") %>" alt="">
				<div id="gs_right_middle">
					<p><b>Can I burn or export classes that I download from this web site?</b></p>
					<p>Yes, most of the classes from this web site are burnable to CD or exportable to a device.</p>
				</div>
