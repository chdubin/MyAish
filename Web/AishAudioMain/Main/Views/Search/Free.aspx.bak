       ...
       {%>
        ...
        <div class="rightpart_mp3">
            <div class="rightpart_mp3">
                ...
                <%} %>
                    <a href="#" onclick="return streamPopupflex('<%= Url.Action("Class", "Search") + "?id=" + item.ClassID %>',670,230)" class="search_title">
            ...
            <div class="rightpart_mp3">
                ...
                <div class="search_details">
                    <a href="#" onclick="return streamPopupflex('<%= Url.Action("Class", "Search") + "?id=" + item.ClassID %>',670,230)">DETAILS </a>
                </div>
            </div>
        </div>
    </div>
