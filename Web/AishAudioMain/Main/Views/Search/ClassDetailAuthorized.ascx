            ...
            <div class="left_img">
                   ...
                   { %>
                        ...
                        <div class="mp3_item">
                            ...
                            <% if (Model.IsFree)
                               {
                                   %>
                                   <!--<a target="_blank" href="javascript:void(0)" onclick="return streamPopupflex('<%= Url.Action("GetFreeStream", "Audio") + "?id=" + Model.FileID %>',250,220)">-->
                                   <a href="#" onclick="return streamPopupflex('<%= Url.Action("Class", "Search") + "?id=" + Model.ClassID + "&sp=true" %>',670,400)"> 
                ...
                <% if (Model.IsFree && Model.FileAvailable)
                   { %>
                        ...
                        <a href="#" onclick="return streamPopupflex('<%= Url.Action("Class", "Search") + "?id=" + Model.ClassID + "&sp=true"  %>',670,400)" class="search_details"> 
                            <img height="25" border="0" width="60" alt="FREE Listening" src="<%=Url.Image("listen_on.jpg") %>" />
                        </a>
