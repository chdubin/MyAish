...
<asp:Content ID="additionalNav" ContentPlaceHolderID="rightAdditionalNav" runat="server">
    <div>
        <h3><a href="#">User Options</a></h3>
            <div>
                <ul class="side-menu">
                    <li><a href="<%= Url.Action("EditUserInfo","User",  new { user_id = ViewData["UserId"] }) %>" title="Edit User">Edit User Info</a></li>
                    <li><%=Html.ActionLink("View Files", "ClassActivityLog", new { user_id = ViewData["UserId"] })%></li>
                    <li><a href="<%= Url.Action("ViewFiles","User",  new { user_id = ViewData["UserId"] })%>" title="">Add Downloads</a></li>
                    <li><a href="<%= Url.Action("ViewShoppingTransactions", new { user_id = ViewData["UserId"] }) %>" title="">View Transactions</a></li>
                    <li style="border-bottom: none;">&nbsp;</li>
                    <li><%=Html.ActionLink("Change CC", "ChangeCreditCard", new { user_id = ViewData["UserId"] })%></li>
                    <li style="border-bottom: none;">&nbsp;</li>
                    <li>
                        <%--<a href="<= Url.Action("PlaceOrder","User",  new { user_id = ViewData["UserId"] }) >">--%>
                            Place Order
                        <%--</a> --%>
                    </li>
                    <li>
                        <%--<a href="<= Url.Action("EnterReturn","User",  new { user_id = ViewData["UserId"] }) >">--%>
                            Enter Return
                        <%--</a> --%>
                    </li>
                </ul>
