...
<script type="text/javascript">
    ...
    <td style="text-align:right;" align="right">
        <a class="btn ui-state-default" href="<%= Url.Action("Index", "User", new RouteValueDictionary { { "downloadtype","text" }, { "ps", ((Main.Areas.Admin.Models.Common.PagingData)ViewData["Pager"]).PageSize } } ) %>"><span class="ui-icon ui-icon-circle-plus"></span>Download as Text</a>
        <a class="btn ui-state-default" href="<%= Url.Action("Index", "User", new RouteValueDictionary { { "downloadtype","excel" }, { "ps", ((Main.Areas.Admin.Models.Common.PagingData)ViewData["Pager"]).PageSize } } ) %>"><span class="ui-icon ui-icon-circle-plus"></span>Download All as Excel 2007</a>
    </td>
    </tr>
    </table>
