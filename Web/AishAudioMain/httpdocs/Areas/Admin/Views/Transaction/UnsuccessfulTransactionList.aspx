...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="title title-spacing">
        <h2>Transaction Report - <%=ViewData["Title"] %> - Unsuccessful Transactions Only</h2>
    </div>
	...
	<div class="hastable">
        <table>
            ...
            <tr>
                ...
                <td><%=((MainEntity.Models.Activity.LastActivityLog[]) ViewData["Activity"])
                    .Where(a=>a.UserId==item.UserId)
                    .Select(a=>a.Title + "<br />" +(a.Date!=null?a.Date.Value.ToString("dd/MM/yyyy hh:mm:ss"):string.Empty)).FirstOrDefault() %></td>
            </tr>
            <%} %>
            </tbody>
        </table>
