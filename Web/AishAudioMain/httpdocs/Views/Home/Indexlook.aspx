...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
    ...
    <div id="blue_field">
        <div style="float: left; width: 448px;">
            <a href="https://aishaudio.com/search/resultsdetail/cat/3-weeks"><img height="226" border="0" width="446" src="<%= Url.Image("five_surfers_446x226.jpg") %>" alt="Tisha B Av"></a>
  ...
  <div style="float: right; width: 145px;">
            <a href="https://aishaudio.com/search/resultsdetail/cat/specialemail"><img height="109" border="0" width="145" src="<%= Url.Image("SS_801_wonders_of_creation_145x109.jpg") %>" alt="moment"><br />
            <br />
            </a>
            <a href="https://aishaudio.com/search/resultsdetail/cat/specialemail"><img height="109" border="0" width="145" src="<%= Url.Image("BY_941_does_god_desire_pray.jpg") %>" alt="inner">
           </a>      
            ...
            <div style="width: 145px; height: 101px; margin-top: 9px;">                
                ...
                <a href="/search/<%= menuActionName %>/code/044"><img style="vertical-align: top;" align="top" width="145" src="<%= Url.Image("editor_p.jpg") %>"
        ...
        <div style="width: 295px; float: right;">
            ...
            <div>
              ...
              <ul>
                                          ...
                                          <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/044">Devarim</a><a href="/search/<%= menuActionName %>/code/038"></a></li>     
                     <li>                     
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/045">Va'eschanon</a></li>                                              <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/046">Eikev</a><a href="/search/<%= menuActionName %>/code/037"></a></li>                                                               
