...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
    ...
    <div id="blue_field">
        <div style="float: left; width: 448px;">
            <a href="https://aishaudio.com/search/resultsdetail/cat/three"><img height="226" border="0" width="446" src="<%= Url.Image("GT_789_Bive_surfers_446x226.jpg") %>" alt="Tisha B Av"></a>
  ...
  <div style="float: right; width: 145px;">
            <a href="https://aishaudio.com/search/resultsdetail/cat/three"><img height="109" border="0" width="145" src="<%= Url.Image("SS_801_wonders_of_creation_145x109.jpg") %>" alt="moment"><br />
            <br />
            </a>
            <a href="https://aishaudio.com/search/resultsdetail/cat/three"><img height="109" border="0" width="145" src="<%= Url.Image("BY_941_does_god_desire_pray.jpg") %>" alt="inner">
           </a>      
