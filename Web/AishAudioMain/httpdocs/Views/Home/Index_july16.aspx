...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
  ...
  <div style="float: right; width: 145px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("GH_801_A_Prophetic_Codes_Em.jpg") %>" alt="codes"><br />
            <br />
            </a>
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("KE_841_C_driven_145x109_red.jpg") %>" alt="Driven">
           </a>      
            ...
            <div style="width: 145px; height: 101px; margin-top: 9px;">                
                ...
                <a href="/search/<%= menuActionName %>/code/042"><img style="vertical-align: top;" align="top" width="145" src="<%= Url.Image("editor_p.jpg") %>"
        ...
        <div style="width: 295px; float: right;">
            ...
            <div>
              ...
              <ul>
                                              ...
                                              <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/042">Mattos/ Masei</a><a href="/search/<%= menuActionName %>/code/037"></a></li>
   
                                          <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/044">Devorim</a><a href="/search/<%= menuActionName %>/code/038"></a></li>     
                                          
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/045">Va'eschanon</a>                                                               
