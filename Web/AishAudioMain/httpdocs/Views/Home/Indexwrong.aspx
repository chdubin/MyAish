...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
    ...
    <div id="blue_field">
        <div style="float: left; width: 448px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="226" border="0" width="446" src="<%= Url.Image("yk.gif") %>" alt="Jewish Holidays"></a>
            <a href="/Yom-Kippur"><img height="33" border="0" width="449" style="margin-top: 9px;" src="<%= Url.Image("Torah-Po.png")%>"
                    alt="Torah Portion" /></a>
