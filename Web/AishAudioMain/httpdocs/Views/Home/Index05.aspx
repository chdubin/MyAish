...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
    ...
    <div id="blue_field">
        <div style="float: left; width: 448px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="226" border="0" width="446" src="<%= Url.Image("GA_809_Jewish_View_of_Jewish.jpg") %>" alt="History"></a>
  ...
  <div style="float: right; width: 145px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("FG_617_How_Judgements_Boome.jpg") %>" alt="Soul"><br />
            <br />
            </a>
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("GC_626_P_adolecensce_1_145x109.jpg") %>" alt="5 Books">
           </a>      
            ...
            <div style="width: 145px; height: 101px; margin-top: 9px;">                
                ...
                <a href="/search/<%= menuActionName %>/code/036"><img style="vertical-align: top;" align="top" width="145" src="<%= Url.Image("editor_p.jpg") %>"
        ...
        <div style="width: 295px; float: right;">
            ...
            <div>
              ...
              <ul>
                                              ...
                                              <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/034">Bamidbar</a><a href="/search/<%= menuActionName %>/code/034"></a></li>
                                              <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/035">Naso</a><a href="/search/<%= menuActionName %>/code/032"></a></li>
                                          <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/036">Beha'aloscha</a><a href="/search/<%= menuActionName %>/code/029"></a></li>    
