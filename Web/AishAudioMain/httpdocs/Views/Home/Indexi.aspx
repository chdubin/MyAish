...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
    ...
    <div id="blue_field">
        <div style="float: left; width: 448px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="226" border="0" width="446" src="<%= Url.Image("jewish_holidays_446x226.jpg") %>" alt="Jewish Holidays"></a>
            <a href="https://aishaudio.com/search/resultsdetail/cat/Sukkot"><img height="33" border="0" width="449" style="margin-top: 9px;" src="<%= Url.Image("sk.gif")%>"
                    alt="Sukkot" /></a>
  ...
  <div style="float: right; width: 145px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("RH_general_145x109.jpg") %>" alt="Rosh Hashana"><br />
            <br />
            </a>
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("LZ_600_A_single_important_goal_145X1.jpg") %>" alt="Goal">
           </a>      
            ...
            <div style="width: 145px; height: 101px; margin-top: 9px;">                
                ...
                <a href="/search/<%= menuActionName %>/code/051"><img style="vertical-align: top;" align="top" width="145" src="<%= Url.Image("editor_p.jpg") %>"
    ...
    <div class="midArticlesBg">
        ...
        <div style="width: 295px; float: right;">
            ...
            <div>
              <h1>
                <a href="/static/TorahPortions">TORAH PORTION </a></h1>
              <ul>
                       
                
 
                                          <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/051">Nitzavim</a></li>  
                                           <li>                     
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/052">Vayelech</a></li>                     <li>
                       <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/053">Ha'azinu</a></li>                                                                                   
    ...
    <div style="margin-left: 40px;">
        ...
        <a href="javascript:openpopup('http://www.classicsinai.com/happiness_stream_s.htm')"><img style="margin-right: 20px;" border="0" alt="3" src="<%= Url.Image("happines.jpg") %>" /></a>
        ...
        <a href="javascript:openpopup('http://www.classicsinai.com/torah_s.htm')"><img style="margin-right: 20px;" border="0" alt="5" src="<%= Url.Image("torah000.jpg") %>" /></a>
        <a href="javascript:openpopup('http://www.classicsinai.com/bodies_stream_S.htm')"><img border="0" alt="4" src="<%= Url.Image("our_bodi.jpg") %>" /></a>
    </div>
