...
<p>Here is a link to a free audio class that I think you will like.
    
</p>
<p>It is called $classname?, and <a href=$link>here is the link</a>.</p>
<p> Enjoy!</p>$wi_sendermail
</body>
</html>
';
...
echo $to, $subject, $message, $headers, $emailcode;
