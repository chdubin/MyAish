...
<% string menuActionName = MainBL.CookieBL.ShowDetailed(Request.Cookies, Response.Cookies) ? "resultsdetail" : "results"; %>
    ...
    <div id="blue_field">
        <div style="float: left; width: 448px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="226" border="0" width="446" src="<%= Url.Image("LZ_540_D_elul_gaining_the_l.jpg") %>" alt="Elul"></a>
  ...
  <div style="float: right; width: 145px;">
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("BY_941_does_god_desire_pray.jpg") %>" alt="Prayer"><br />
            <br />
            </a>
            <a href="<%=Url.Action("Free","Home") %>"><img height="109" border="0" width="145" src="<%= Url.Image("KY_952_D_How_Long_Should_I_Tolerate_145x109.jpg") %>" alt="Tolerate">
           </a>      
            ...
            <div style="width: 145px; height: 101px; margin-top: 9px;">                
                ...
                <a href="/search/<%= menuActionName %>/code/048"><img style="vertical-align: top;" align="top" width="145" src="<%= Url.Image("editor_p.jpg") %>"
        ...
        <div style="width: 295px; float: right;">
            ...
            <div>
              ...
              <ul>
                                              ...
                                              <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/048">Shoftim</a><a href="/search/<%= menuActionName %>/code/037"></a></li>   
                                          <li>
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/049">Ki Setzei</a><a href="/search/<%= menuActionName %>/code/038"></a></li>  
                                           <li>                     
                      <img border="0" alt="Bullet" src="<%= Url.Image("square-b.gif") %>"> <a href="/search/<%= menuActionName %>/code/050">Ki Savo</a></li>                     
